...
if step == '+':
    ...
    for chel in fam_bthd.keys():
        ...
        if check == 3: good_answ += 1 # если счетчик 3, ответ верен и плюсуем
            ...
            day = bithday[0]
            # от 1 до 9
            if day[0] == '0' or day == '10': day = edn[int(day[1:])-1]
            # от 11 до 19
            elif day[0] == '1' and day[0] != '0': day = specil[int(day[1:])-1]+specil[-1]
            # 10,20,30
            elif day in ('10', '20', '30'): day_ = dacad[int(day[0])-1]
            # другие
            else: day = des[int(day[0])-2]+' '+edn[int(day[1:])-1]
